...
const authorSchema = new Schema({
    ...
    lastName : {
        ...
        min: [AUTHOR_MIN_AGE, `author must age which is bigger than ${AUTHOR_MIN_AGE},got {VALUE}`],
        max: [AUTHOR_MAX_AGE, `author must have age less than ${AUTHOR_MAX_AGE},got {VALUE}`]
    }
})
